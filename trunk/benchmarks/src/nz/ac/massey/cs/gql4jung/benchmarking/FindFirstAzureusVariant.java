...
/**
 * Finds the first result, and measures the time needed to do so.
 * The time needed to import / build the graph from byte code is not included. 
 * @author jens dietrich
 */
public class FindFirstAzureusVariant extends Utils {
