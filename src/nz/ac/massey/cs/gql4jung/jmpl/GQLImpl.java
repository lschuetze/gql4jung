 ...
 */
public class GQLImpl<V extends Vertex<E>,E extends Edge<V>> extends GQLImplCore<V,E> {
	public GQLImpl() {
		super();
	}
	...
	@Override
	public void query(DirectedGraph<V,E> graph, Motif motif, ResultListener<V,E> listener,boolean ignoreVariants) {
