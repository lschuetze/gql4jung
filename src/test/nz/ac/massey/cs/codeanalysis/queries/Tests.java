...
package test.nz.ac.massey.cs.codeanalysis.queries;
...
public abstract class Tests {
	...
	static DirectedGraph<TypeNode,TypeReference> loadGraph(String name) throws Exception {
        String src = "/test/nz/ac/massey/cs/codeanalysis/queries/data/"+name;
	...
	static Motif loadQuery(String name) throws Exception {
		String src = "/test/nz/ac/massey/cs/codeanalysis/queries/defs/"+name;
